...
\textbf{terminate}: Nur von interne Prozesse zu verwenden. Startet den Terminierungsprozess.\\

\textbf{{reply, ok}}: Nur von interne Prozesse zu verwenden. Signalisiert, dass alle Submodule und Prozesse des Servers
...
\begin{enumerate}
    ...
    \item{Name definiert den Namen des Servers}
